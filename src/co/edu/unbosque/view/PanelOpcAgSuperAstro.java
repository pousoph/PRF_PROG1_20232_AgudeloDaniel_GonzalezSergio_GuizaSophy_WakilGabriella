 ...
 * agregación de información sobre SuperAstro.
 * 
 * @author AgudeloDaniel, GuizaSophy, GonzalezSergio, WakilGabriella 25-11-2023
 */

public class PanelOpcAgSuperAstro extends JPanel {

	private JButton btn1, btn2;

	/**
	 * Constructor de la clase PanelOpcAgSuperAstro. Configura el diseño del panel y
	 * agrega botones con funcionalidades específicas para la agregación de
	 * información sobre SuperAstro.
	 */

	public PanelOpcAgSuperAstro() {
		btn1 = new JButton("Agregar");
		btn1.setActionCommand("AGREGARAPSUPER");
		btn1.setBackground(new Color(134, 124, 157));
		ImageIcon temporal3 = new ImageIcon("./imgs/button_accAgregar.png");
		...
		btn2.setActionCommand("SALIR AGAPCSUPER");
