 ...
 * agregación de apostadores.
 * 
 * @author AgudeloDaniel, GuizaSophy, GonzalezSergio, WakilGabriella 25-11-2023
 */

public class PanelOpcAgApostador extends JPanel {

	private JButton btn1, btn2;

	/**
	 * Constructor de la clase PanelOpcAgApostador. Configura el diseño del panel y
	 * agrega botones con funcionalidades específicas para la agregación de
	 * apostadores.
	 */

	public PanelOpcAgApostador() {
		// TODO Auto-generated constructor stub
		btn1 = new JButton("Agregar");
		btn1.setActionCommand("AGREGARAPOSTADOR");
		...
		btn2.setActionCommand("SALIR AGAPOSTADOR");
