 ...
 * actualización de datos de Betplay.
 * 
 * @author AgudeloDaniel, GuizaSophy, GonzalezSergio, WakilGabriella 25-11-2023
 */

public class PanelOpcActBetplay extends JPanel {

	private JButton btn1, btn2;

	/**
	 * Constructor de la clase PanelOpcActBetplay. Configura el diseño del panel y
	 * agrega botones con funcionalidades específicas para la actualización de datos
	 * de Betplay.
	 */

	public PanelOpcActBetplay() {
		btn1 = new JButton("Actualizar");
		btn1.setActionCommand("ACTUALAPBETPLAY");
		...
		btn2.setActionCommand("SALIR ACTAPBETPLAY");
