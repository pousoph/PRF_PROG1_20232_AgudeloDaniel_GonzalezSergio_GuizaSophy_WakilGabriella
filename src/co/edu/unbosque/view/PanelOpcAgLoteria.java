 ...
 * agregación de Lotería.
 * 
 * @author AgudeloDaniel, GuizaSophy, GonzalezSergio, WakilGabriella 25-11-2023
 */

public class PanelOpcAgLoteria extends JPanel {

	private JButton btn1, btn2;

	/**
	 * Constructor de la clase PanelOpcAgLoteria. Configura el diseño del panel y
	 * agrega botones con funcionalidades específicas para la agregación de Lotería.
	 */

	public PanelOpcAgLoteria() {
		btn1 = new JButton("Agregar");
		btn1.setActionCommand("AGREGARAPLOTERIA");
		...
		btn2.setActionCommand("SALIR AGAPLOTERIA");
