...
/**
 * 
 * Panel que contiene dos botones para la configuración de la casa de apuestas.
 * 
 * @author AgudeloDaniel, GuizaSophy, GonzalezSergio, WakilGabriella 25-11-2023
 */

public class PanelBotonesCfgCasaApuestas extends JPanel {
	...
	public PanelBotonesCfgCasaApuestas() {
		// TODO Auto-generated constructor stub
		btn1 = new JButton("Configuracion");
		btn1.setActionCommand("CONFIGURAR CASA APUESTAS");
		...
		btn2.setActionCommand("SALIR CONFIGURACIONCASA");
