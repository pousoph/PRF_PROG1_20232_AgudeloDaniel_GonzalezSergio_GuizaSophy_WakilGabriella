 ...
 * agregación de Betplay.
 * 
 * @author AgudeloDaniel, GuizaSophy, GonzalezSergio, WakilGabriella 25-11-2023
 */

public class PanelOpcAgBetplay extends JPanel {

	private JButton btn1, btn2;

	/**
	 * Constructor de la clase PanelOpcAgBetplay. Configura el diseño del panel y
	 * agrega botones con funcionalidades específicas para la agregación de Betplay.
	 */

	public PanelOpcAgBetplay() {
		btn1 = new JButton("Agregar");
		btn1.setActionCommand("AGREGARAPBETPLAY");
		...
		btn2.setActionCommand("SALIR AGAPBETPLAY");
