 ...
 * actualización de datos de Lotería.
 * 
 * @author AgudeloDaniel, GuizaSophy, GonzalezSergio, WakilGabriella 25-11-2023
 */

public class PanelOpcActLoteria extends JPanel {

	private JButton btn1, btn2;

	/**
	 * Constructor de la clase PanelOpcActLoteria. Configura el diseño del panel y
	 * agrega botones con funcionalidades específicas para la actualización de datos
	 * de Lotería.
	 */

	public PanelOpcActLoteria() {
		btn1 = new JButton("Actualizar");
		btn1.setActionCommand("ACTUALLOTERIA");
		...
		btn2.setActionCommand("SALIR ACTLOTERIA");
